...
<H1 class="title">Room Listings</H1>
	<div class="container">
					...
					<c:if test="${room.size() > 0}">
						<c:forEach  items="${room}" var="roomValue">
							<tr>
								...
								<td class=""><a href="<c:url value="/editroom/${roomValue.getId()}"/>"><button class="btn btn-success">Edit <i class="fa fa-pencil-square-o"></i></button></a></td>
								<td class=""><button class="btn btn-danger" data-href="<c:url value="/deleteroom/${roomValue.getId()}"/>" data-toggle="modal" data-target="#confirm-delete"> Delete
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure that you want to delete this room</p>
