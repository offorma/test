...
<H1 class="title">Module Listings</H1>
	<div class="container">
					...
					<c:if test="${module.size() > 0}">
						<c:forEach  items="${module}" var="moduleValue">
							<tr>
								...
								<td class=""><a href="<c:url value="/editmodule/${moduleValue.getId()}"/>"><button class="btn btn-success">Edit <i class="fa fa-pencil-square-o"></i></button></a></td>
								<td class=""><button class="btn btn-danger" data-href="<c:url value="/deletemodule/${moduleValue.getId()}"/>" data-toggle="modal" data-target="#confirm-delete"> Delete
