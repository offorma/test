...
<H1 class="title">Edit Student Group</H1>
	<div class="container">
		<div class="row landing">
			...
			<c:choose>
				...
				<form  method="post" action="<c:url value="/editstudent/${student.getGroupId()}"/>">
					<div class="form-group">
						<label for="Studentgroup">Student Group Name</label> <input
							type="text" class="form-control" name="Studentgroup" id= "Studentgroup" value = "${student.getGroupName()}"></input>
					</div>
					<div class="form-group">
						<label for="Totalnumber">Total Number</label> <input
							type="text" class="form-control" name="Totalnumber" id="Totalnumber" value = "${student.getNumberOfStudent()}"></input>
					</div>
