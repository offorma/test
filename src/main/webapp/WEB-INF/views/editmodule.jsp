		...
		<div class="row landing">
			...
			<c:choose>
			   ...
			   <c:choose>
				...
				<form method="post" action="<c:url value="/editmodule/${module.getId()}"/>">
					<div class="form-group">
						<label for="Modulecode">Module Code</label> <input
							type="text" class="form-control" name="Modulecode" id= "Modulecode" value="${module.getModuleCode()}"></input>
					</div>
					<div class="form-group">
						<label for="Modulename">Module Name</label> <input
							type="text" class="form-control" name="Modulename" id="Modulename" value="${module.getModuleName()}"></input>
					</div>
					<div class="form-group">
						<label for="Weeklyhour">Total Weekly Hour</label> <input
							type="text" class="form-control" name="Weeklyhour" id="Weeklyhour" value="${module.getTotalWeeklyHour()}"></input>
					</div>
