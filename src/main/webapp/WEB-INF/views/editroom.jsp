		...
		<div class="row landing">
			...
			<c:choose>
			   ...
			   <c:choose>
				...
				<form method="post" action="<c:url value="/editroom/${room.getId()}"/>">
					<div class="form-group">
						<label for="RoomNumber">Room Number</label> <input
							type="text" class="form-control" name="RoomNumber" id= "RoomNumber" value="${room.getRoomNumber()}"></input>
					</div>
					<div class="form-group">
						<label for="Capacity">Capacity</label> <input
							type="text" class="form-control" name="Capacity" id="Capacity" value="${room.getCapacity()}"></input>
					</div>
					<div class="form-group">
						<label for="Building">Building</label> <input
							type="text" class="form-control" name="Building" id="Building" value="${room.getBuilding()}"></input>
					</div>
					<div class="radio">
					<c:choose>
					    <c:when test='${room.getType().equals("Lecture")}'>
					        <label> <input type="radio" name="type" value="Lecture" checked="checked"></input> Lecture </label>
					    </c:when>    
					    <c:otherwise>
					        <label> <input type="radio" name="type" value="Lecture"></input> Lecture </label>
					    </c:otherwise>
					</c:choose>
					<c:choose>
					      <c:when test='${room.getType().equals("Labs")}'>
					        <label> <input type="radio" name="type" value="Labs" checked="checked"></input> Labs </label>
					    </c:when>    
					    <c:otherwise>
					 ...
					 <c:choose>
					     <c:when test='${room.getType().equals("Both")}'>
					        <label> <input type="radio" name="type" value="Both" checked="checked"></input> Both </label>
					    </c:when>    
					    <c:otherwise>
